    ...
    <nav className="bg-indigo-600 text-white">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            >
              <Package size={24} />
              <span>AM COSMETICS AND PERFUME</span>
            </Link>
          </div>
      ...
      <div className="md:hidden border-t border-indigo-700">
        <div className="grid grid-cols-4 text-center">
          ...
          <Link to="/inventory" className={`py-3 ${isActive("/inventory")}`}>
            <Package size={20} className="mx-auto" />
            <span className="text-xs">Inventory</span>
          </Link>

          <Link to="/sales" className={`py-3 ${isActive("/sales")}`}>
            <ShoppingCart size={20} className="mx-auto" />
            <span className="text-xs">Sales</span>
          </Link>

          <Link to="/reports" className={`py-3 ${isActive("/reports")}`}>
